...
| Framework | Libraries                                                                  |
| --------- | -------------------------------------------------------------------------- |
| Django    | [`django-otp-webauthn`](https://github.com/Stormbase/django-otp-webauthn), [`django-passkeys`](https://github.com/mkalioby/django-passkeys),[`django-allauth`](https://forum.djangoproject.com/t/django-allauth-64-0-0-released-webauthn-passkey-support/33464) |
| Node.JS | [`@simplewebauthn/server`](https://github.com/MasterKale/SimpleWebAuthn), [`@passwordless-id/webauthn`](https://www.npmjs.com/package/@passwordless-id/webauthn) |
| Symfony | [`web-auth/webauthn-framework`](https://github.com/web-auth/webauthn-framework) |
| Laravel | [`laragear/webauthn`](https://github.com/Laragear/WebAuthn) |
| Ruby on Rails | [`webauthn-ruby`](https://github.com/cedarcode/webauthn-ruby) |
